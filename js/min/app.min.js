...
Handlebars.registerHelper("dateFormat",function(e){var t=new Date(1e3*e),r=t.getDate(),a=t.getMonth()+1,n=t.getFullYear();return""+n+"-"+(9>=a?"0"+a:a)+"-"+(9>=r?"0"+r:r)});
$(function(){function e(){var e=JSON.parse(sessionStorage.getItem("behanceUser")),t=$("#profile-template").html(),a=Handlebars.compile(t),n=a(e);$("#header").html(n)}function t(){var e=JSON.parse(sessionStorage.getItem("behanceProject")),t=$("#portfolio-template").html(),a=Handlebars.compile(t),n=a(e);$("#portfolio").html(n)}var a="gokhanaltinigne",n="PynPRo9HTgL90ktNFI46b4H9Cd17f3Bf",s="http://www.behance.net/v2/users/"+a+"?callback=?&api_key="+n,o=12,r="http://www.behance.net/v2/users/"+a+"/projects?callback=?&api_key="+n+"&per_page="+o;sessionStorage.getItem("behanceUser")?e():$.getJSON(s,function(t){sessionStorage.setItem("behanceUser",JSON.stringify(t)),e()}),sessionStorage.getItem("behanceProject")?t():$.getJSON(r,function(e){sessionStorage.setItem("behanceProject",JSON.stringify(e)),t()})});